...
hl.window_rule({ match = { class = "^(zen)$" }, workspace = "2", fullscreen_state = 0 })
hl.window_rule({ match = { class = "^(org.wezfurlong.wezterm)$" }, fullscreen = true })
...
hl.window_rule({ match = { class = "^(org.pwmt.zathura)$" }, workspace = "6" })
hl.window_rule({ match = { class = "^(chromium)$" }, workspace = "6" })
hl.window_rule({ match = { class = "^(vimiv)$" }, workspace = "7" })
hl.window_rule({ match = { class = "^(swayimg)$" }, workspace = "7" })
hl.window_rule({ match = { class = "^(tixati)$" }, workspace = "8" })
hl.window_rule({ match = { class = "^(xdm-app)$" }, workspace = "9" })
hl.window_rule({ match = { class = "^(com.mitchellh.ghostty)$" }, opacity = "0.7 0.7" })
